...
fun LearnWordsScreen(
    ...
    WordSessionBody(
        ...
        onForkWordTranslation = { translation -> viewModel.forkCurrentWordTranslation(translation) },
        ...
        onForkVoiceCardWordTranslation = { translation -> viewModel.forkCurrentVoiceCardWordTranslation(translation) },
